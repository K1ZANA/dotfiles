...
A collection of my dotfiles / configs.
...
## What do i use?
For the Fish Shell, i use the default theme of Starship.
As my Fetch, i use Neofetch.
As my Terminal, i use Kitty.

## Whats my current colorscheme?

I currently use Catpuccin.
